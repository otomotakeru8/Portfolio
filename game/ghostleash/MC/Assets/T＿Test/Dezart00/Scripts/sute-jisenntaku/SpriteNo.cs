...
public abstract class SpriteNo<T> : MonoBehaviour where T : Component
{
    ...
    //スクリプト取得
    //public MoveNotes playerScript1, playerScript2, playerScript3, playerScript4;
    int Score;
    [SerializeField]
    public SpriteRendererNo _spriteRendererNo;

    //[SerializeField]
    //private string _spriteRendererNo;
    ...
    void Update()
    {
        //Score = playerScript1.GetScore_score() + playerScript2.GetScore_score() + playerScript3.GetScore_score() + playerScript4.GetScore_score();

        _spriteRendererNo.SetNo(Score);
    }
}